...
/* package Haskercises-0.1.0.0 */
#define VERSION_Haskercises "0.1.0.0"
#define MIN_VERSION_Haskercises(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package aeson-pretty-0.8.2 */
#define VERSION_aeson_pretty "0.8.2"
...
#define CURRENT_COMPONENT_ID "Haskercises-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Haskercises-0.1.0.0"
